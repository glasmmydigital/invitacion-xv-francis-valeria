export const TEXT_ES: { [key: string]: string } = {
  ...
  textoRegaloDos: 'Tu presencia es lo más importante para mí y el mejor regalo que puedo recibir. Sin embargo, si deseas tener un detalle, te comparto estas opciones:',
  ...
  subtituloHoteles: 'Hoteles y Estilistas',
  clic1: 'Clic para ver opciones:',
  website: 'Sitio Web',
  buttonRedes1: 'Contacto',
  buttonRedes2: 'Contacto Maquillaje',
